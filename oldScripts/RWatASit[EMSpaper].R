...
#################      R WatASit      ################################
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# This script pilotes the WatASit multi-agent model in Cormas plateform
...
legend("top",
       legend = levels(factor(rpg@data$abandoned, levels=c('Abandoned irrigation', 'Other'))),
...
x11(); plot(rpg, col=rpg@data$COLOUR, border = NA, axes = F)
title(main = "Irregular irrigation", sub = "(Fingers are farmer ID, parcels with no ID are not part \n of farms using the collective irrigation network)")
text(coordinates(rpg), labels=rpg$ID_EXPL,font=1,cex=0.65, col="black")
legend("top",
       legend = levels(factor(rpg@data$unrespect, levels=c('Irregular irrigation','Other'))),
       fill = c("#ef6548","#bdbdbd"))
savePlot(filename = paste0("save/irregular_end_",scenario,".png"), device = dev.cur())
...
x11(); plot(rpg, col=rpg@data$COLOUR, border=NA,axes = F)
title(main = "Irregular flood affordance", sub = "(Fingers are farmer ID, parcels with no ID are not part \n of farms using the collective irrigation network)")
text(coordinates(rpg), labels=rpg$ID_EXPL,font=1,cex=0.65,col="black")
# legend("top",
...
x11(); plot(rpg, col=rpg@data$COLOUR, border=NA,axes = F)
title(main = "Irregular flood action", sub = "(Fingers are farmer ID, parcels with no ID are not part \n of farms using the collective irrigation network)")
text(coordinates(rpg), labels=rpg$ID_EXPL,font=1,cex=0.65,col="black")
# legend("top",
